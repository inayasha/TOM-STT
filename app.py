    ...
    try:
        ...
        for i in range(total_chunks):
            ...
            .stt-overlay {{
                ...
                overflow-y: auto; padding: 20px; box-sizing: border-box; /* FIX: Izinkan Scroll di HP */
            }}
            .stt-spinner {{
            ...
            .stt-preview {{ width: 90%; max-width: 700px; height: 150px; max-height: 35vh; background: #F8F9FA; border: 1px solid #DDD; border-radius: 10px; padding: 15px; overflow-y: auto; color: #333; font-size: 13px; text-align: left; margin-top: 10px; box-shadow: inset 0 2px 5px rgba(0,0,0,0.05); line-height: 1.5; flex-shrink: 0; }}
            
            /* FIX: Ukuran Mengecil Otomatis di Layar Handphone */
